<?php
	...
	class Team extends Entity {
		...
		public function getAuthsList() {

			return $this->authsList;
		}

		public function setAuthsList($authsList) {
		...
		public function getHasMasterServer() {

			return $this->hasMasterServer;
		}

		public function setHasMasterServer($hasMasterServer) {

			$this->hasMasterServer = $hasMasterServer;
