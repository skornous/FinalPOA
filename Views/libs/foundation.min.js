!function (t) {
    ...
    var s = "6.0.5", o = {
        version: s, _plugins: {}, _uuids: [], _activePlugins: {}, rtl: function () {
            ...
            t.uuid = this.GetYoDigits(6, i), t.$element.attr("data-" + i) || t.$element.attr("data-" + i, t.uuid), t.$element.trigger("init.zf." + i), this._activePlugins[t.uuid] = t
            ...
            t.each(n, function (n, o) {
                ...
                r.each(function () {
                    var e = t(this), n = {};
                    if (e.data("zf-plugin"))return void console.warn("Tried to initialize " + o + " on an element that already has a Foundation plugin.");
    ...
    }, t.plugin(i, "Abide"), "undefined" != typeof module && "undefined" != typeof module.exports && (module.exports = i), "function" == typeof define && define(["../../js/foundation"], function () {
        return i
    })
    ...
    i.defaults = {
        ...
        this.$submenuAnchors = this.$element.find("li.has-submenu"), this.$submenus = this.$submenuAnchors.children("[data-submenu]"), this.$menuItems = this.$element.find("li:visible").not(".js-drilldown-back").attr("role", "menuitem"), this._prepareMenu(), this._keyboardEvents()
        ...
        this.$element.on({
            ...
            e.Keyboard.handleKey(n, i, {
                tab_forward: function () {
                    this.$element.find(":focus").is(o.eq(-1)) && (this.options.trapFocus ? (o.eq(0).focus(), n.preventDefault()) : this.close())
                }, tab_backward: function () {
                    (this.$element.find(":focus").is(o.eq(0)) || this.$element.is(":focus")) && (this.options.trapFocus ? (o.eq(-1).focus(), n.preventDefault()) : this.close())
                }, open: function () {
    ...
    "use strict";
    function i(n, s) {
        this.$element = n, this.options = t.extend({}, i.defaults, this.$element.data(), s), e.Nest.Feather(this.$element, "dropdown"), this._init(), e.registerPlugin(this), e.Keyboard.register("DropdownMenu", {
            ENTER: "open",
            SPACE: "open",
            ARROW_RIGHT: "next",
            ARROW_UP: "up",
    ...
    i.defaults = {
        ...
        (this.options.clickOpen || s) && this.$menuItems.on("click.zf.dropdownmenu touchstart.zf.dropdownmenu", function (e) {
            ...
            r ? n.vertical ? "left" === n.options.alignment ? t.extend(f, {
                ...
                next: u,
                previous: c
            }) : t.extend(f, {down: d, up: h, next: c, previous: u}) : t.extend(f, {
                next: d,
                previous: h,
                down: u,
                up: c
                ...
                down: d,
                up: h
            }) : t.extend(f, {next: c, previous: u, down: d, up: h}), e.Keyboard.handleKey(i, n, f)
        })
    ...
    }, t.plugin(i, "Equalizer"), "undefined" != typeof module && "undefined" != typeof module.exports && (module.exports = i), "function" == typeof define && define(["../../js/foundation"], function () {
        return i
    })
}(Foundation, jQuery), !function (t, e) {
    "use strict";
    ...
    }, t.plugin(i, "Interchange"), "undefined" != typeof module && "undefined" != typeof module.exports && (module.exports = i), "function" == typeof define && define(["../../js/foundation"], function () {
        return i
    })
}(Foundation, jQuery), !function (t, e) {
    "use strict";
    function i(n, s) {
        this.$element = n, this.options = e.extend({}, i.defaults, this.$element.data(), s), this._init(), t.registerPlugin(this)
    }
    ...
    }, t.plugin(i, "Magellan"), "undefined" != typeof module && "undefined" != typeof module.exports && (module.exports = i), "function" == typeof define && define(["../../js/foundation"], function () {
        return i
    })
}(Foundation, jQuery), !function (t, e) {
    "use strict";
    ...
    i.defaults = {
        ...
        this.focusableElements = t.Keyboard.findFocusable(this.$element), this.options.overlay || !this.options.closeOnClick || this.options.fullScreen || e("body").on("click.zf.reveal", function (t) {
            ...
            t.Keyboard.handleKey(e, i, {
                close: function () {
                    this.options.closeOnEsc && (this.close(), this.$anchor.focus())
                }
            ...
            t.Keyboard.handleKey(n, i, {
                tab_forward: function () {
                    this.$element.find(":focus").is(i.focusableElements.eq(-1)) && (i.focusableElements.eq(0).focus(), n.preventDefault())
                }, tab_backward: function () {
                    (this.$element.find(":focus").is(i.focusableElements.eq(0)) || this.$element.is(":focus")) && (i.focusableElements.eq(-1).focus(), n.preventDefault())
                }, open: function () {
    ...
    }, t.plugin(i, "Reveal"), "undefined" != typeof module && "undefined" != typeof module.exports && (module.exports = i), "function" == typeof define && define(["../../js/foundation"], function () {
        return i
    })
}(Foundation, jQuery), !function (t, e) {
    "use strict";
    ...
    i.defaults = {
        ...
        var d = this, h = this.options.vertical, u = h ? "height" : "width", c = h ? "top" : "left", f = t[0].getBoundingClientRect()[u] / 2, p = this.$element[0].getBoundingClientRect()[u], m = n(i, this.options.end).toFixed(2), g = (p - f) * m, v = (100 * n(g, p)).toFixed(this.options.decimal), i = i > 0 ? parseFloat(i.toFixed(this.options.decimal)) : 0, w = {};
    ...
    }, t.plugin(i, "Toggler"), "undefined" != typeof module && "undefined" != typeof module.exports && (module.exports = i), "function" == typeof define && define(["../../js/foundation"], function () {
        return i
    })
