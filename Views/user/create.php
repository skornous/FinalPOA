<div class="container">
	...
	<form method="POST" action="<?php echo BASE_URL; ?>/users/create" name="form_add">
		<div role="form-group" role="form">
			<div class="row">
				<label class="col-sm-2 control-label" for="firstname"><?php echo $lang->FNAME; ?> <span
						class="star-important">*</span></label>
				<div class="col-sm-10 form-group">
					<input type="text" name="firstname" required="required" class="form-control"
					       value="<?php if (isset($formDatas) && isset($formDatas["firstname"])) {
						       echo $formDatas["firstname"];
					       } ?>">
				</div>
			</div>

			<div class="row">
				<label class="col-sm-2 control-label" for="lastname"><?php echo $lang->LNAME; ?> <span
						class="star-important">*</span></label>
				<div class="col-sm-10 form-group">
					<input type="text" name="lastname" required="required" class="form-control"
					       value="<?php if (isset($formDatas) && isset($formDatas["lastname"])) {
						       echo $formDatas["lastname"];
					       } ?>">
				</div>
			</div>

			<div class="row">
				<label class="col-sm-2 control-label" for="email"><?php echo $lang->EMAIL; ?> <span
						class="star-important">*</span></label>
				<div class="col-sm-10 form-group">
					<input type="email" name="email" required="required" class="form-control"
					       value="<?php if (isset($formDatas) && isset($formDatas["email"])) {
						       echo $formDatas["email"];
					       } ?>">
				</div>
			</div>

			<div class="row">
				<label class="col-sm-2 control-label" for="login"><?php echo $lang->LOGIN; ?> <span
						class="star-important">*</span></label>
				<div class="col-sm-10 form-group">
					<input type="text" name="login" required="required" class="form-control"
					       value="<?php if (isset($formDatas) && isset($formDatas["login"])) {
						       echo $formDatas["login"];
					       } ?>">
				</div>
			</div>

			<div class="row">
				<label class="col-sm-2 control-label" for="password"><?php echo $lang->PSWD; ?> <span
						class="star-important">*</span></label>
				...
				<div class="col-sm-2 form-group">
					<input class="btn btn-default" type="button" value=" Generate Password " style="font-size: 1.1em;"
