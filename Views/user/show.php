	...
	<h1>
		<?php echo $lang->USER . " - " . $user->login;
			if ($loggedUser->can("edit", "user")): ?>
				<a href="<?php echo BASE_URL . "/users/modify/" . $user->id; ?>"
				   class="btn btn-primary"><?php echo $lang->MODIFY; ?></a>
			<?php endif; ?>
	</h1>
	<div class="well">
		<div class="container-fluid">
			...
			<div class="row">
				...
				<span class="col-sm-10"><a
						href="mailto:<?php echo $user->email; ?>"><?php echo $user->email; ?></a></span>
			</div>
			<div class="row">
				<em class="col-sm-2"><?php echo $lang->ACTIVE; ?></em>
				<span class="col-sm-10"><span
						class="glyphicon glyphicon-<?php echo ($user->active) ? "ok" : "remove"; ?>"></span></span>
			</div>
			<div class="row">
				<em class="col-sm-2"><?php echo $lang->DELETED; ?></em>
				<span class="col-sm-10"><span
						class="glyphicon glyphicon-<?php echo ($user->deleted) ? "ok" : "remove"; ?>"></span></span>
			</div>
			<div class="row">
