<div class="container">
	...
	<form method="POST" action="" name="form_pswd">
		<div role="form-group" role="form">
			...
			<div class="row">
				<label class="col-sm-3 control-label" for="oldpassword"><?php echo $lang->OLDPSWD; ?> <span class="star-important">*</span></label>  
				<div class="col-sm-9 form-group">
					<input type="password" name="oldpassword" class="form-control" value="">
				</div>
			</div>
			<div class="row">
				<label class="col-sm-3 control-label" for="newpassword1"><button type="button"
						class="btn btn-xs btn-default" data-container="body" data-toggle="popover"
						data-placement="bottom" data-content="<?php echo "$lang->PSWDRULES";?>">?</button> <?php echo $lang->NEWPSWD; ?> <span class="star-important">*</span></label>  
				<div class="col-sm-9 form-group">
					<input type="password" name="newpassword1" class="form-control" value="">
				</div>
			</div>
			<div class="row">
				<label class="col-sm-3 control-label" for="newpassword2"><?php echo $lang->NEWPSWDVERIF; ?> <span class="star-important">*</span></label>  
				<div class="col-sm-9 form-group">
