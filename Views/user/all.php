<div class="container">
	...
	<?php if ($loggedUser->can("add", "user")): ?>
		<a href="<?php echo BASE_URL . "/users/create"; ?>" class="btn btn-success" role="button"
			...
			foreach ($users as $user) {
				if (!$user["deleted"]) {
					...
					<tr class="text-center">
						...
						<td>
							<a href="<?php echo BASE_URL . "/users/" . $user["id"]; ?>"><?php echo $user["login"]; ?></a>
						</td>
						<td><?php echo $user["email"]; ?></td>
						<td><span class="glyphicon glyphicon-<?php echo ($user["active"]) ? "ok" : "remove"; ?>"></span>
						</td>
						<?php if ($loggedUser->can("edit", "user")): ?>
							<td><a class="btn btn-primary"
							       href="<?php echo BASE_URL . "/users/modify/" . $user["id"]; ?>"><?php echo $lang->MODIFY; ?></a>
							</td>
						<?php endif; ?>
						<?php if ($loggedUser->can("delete", "user")): ?>
							<td><a class="btn btn-danger"
							       href="<?php echo BASE_URL . "/users/delete/" . $user["id"]; ?>"><?php echo $lang->DELETE; ?></a>
							</td>
						<?php endif; ?>
					</tr>
					<?php
