...
<div class="container">
	...
	<br><br>
	<form method="POST" action="<?php echo BASE_URL; ?>/datas/<?php echo strtolower($team->name) . "/" . $data["id"];?>" name="form_modify">
		<div role="form-group" role="form">
			<!-- Id -->
			<input type="hidden" name="id" value="<?php echo $data["id"]; ?>" />
			<!-- To -->
			<div class="row">
				<label class="col-sm-2 control-label" for="nb_jobs"><?php echo ucfirst($rows[0]); ?> <span class="star-important">*</span></label>  
				<div class="col-sm-10 form-group">
					<input type="number" step="0.01" name="nb_jobs" required="required" class="form-control" value="<?php echo $data["nb_jobs"]; ?>">
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-10 form-group">
					<input placeholder="<?php echo $lang->DATEFORMAT; ?>" type="date" name="date" required="required" class="form-control" value="<?php echo $data["date"]; ?>">
				</div>
			</div>
