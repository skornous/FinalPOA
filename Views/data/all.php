...
<?php if ($loggedUser->can("add", "server")): ?>
	<a href="<?php echo BASE_URL . "/servers/create";?>" class="btn btn-success" role="button" name="btn_add"><?php echo $lang->ADD; ?></a>
<?php endif;
...
<?php if ($loggedUser->can("edit", "server")): ?>
	<td><a class="btn btn-primary" href="<?php echo BASE_URL . "/servers/modify/" . $server["id"];?>"><?php echo $lang->MODIFY; ?></a></td>
<?php endif; ?>
<?php if ($loggedUser->can("delete", "server")): ?>
	<td><a class="btn btn-danger" href="<?php echo BASE_URL . "/servers/delete/" . $server["id"];?>"><?php echo $lang->DELETE; ?></a></td>
<?php endif; ?>
	</tr>
<?php
			}
