...
<div class="container">
	...
	<?php if ($loggedUser->can("add", "data") && $loggedUser->isPartOf($team->name)): ?>
		<a href="<?php echo BASE_URL . "/datas/" . lcfirst($team->name) . "/create"; ?>" class="btn btn-success"
		   role="button" name="btn_add"><?php echo $lang->ADD; ?></a>
	<?php endif;
				...
				<tr class="text-center">
					...
					<?php if ($loggedUser->can("edit", "data") && $loggedUser->isPartOf($team->name)): ?>
						<td><a class="btn btn-primary"
						       href="<?php echo BASE_URL . "/datas/" . lcfirst($team->name) . "/modify/" . $data["id"]; ?>"><?php echo $lang->MODIFY; ?></a>
						</td>
					<?php endif; ?>
					<?php if ($loggedUser->can("delete", "data") && $loggedUser->isPartOf($team->name)): ?>
						<td><a class="btn btn-danger"
						       href="<?php echo BASE_URL . "/datas/" . lcfirst($team->name) . "/delete/" . $data["id"]; ?>"><?php echo $lang->DELETE; ?></a>
						</td>
					<?php endif; ?>
				</tr>
				<?php
