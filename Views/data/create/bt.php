...
<div class="container">
	...
	<br><br>
	<form method="POST" action="<?php echo BASE_URL; ?>/datas/<?php echo strtolower($team->name); ?>/create"
	      name="form_add">
		<div role="form-group" role="form">
			<!-- nb_jobs -->
			<div class="row">
				<label class="col-sm-2 control-label" for="nb_jobs"><?php echo $rows[0]; ?> <span
			...
			<div class="row">
				...
				<div class="col-sm-10 form-group">
					<input placeholder="<?php echo $lang->DATEFORMAT; ?>" type="date" name="date" required="required"
					       class="form-control" value="<?php if (isset($formDatas) && isset($formDatas["date"])) {
						echo $formDatas["date"];
					} ?>">
				</div>
			</div>
